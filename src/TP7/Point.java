package TP7;
/**
 * Classe Point : point en 3D : 3 coordonnées (double) en X,Y,Z
 */
public class Point {
	...
	/**
	 * Calcule la distance entre le point courant et un point entré en paramètre
	 * @param pCompare
	 *            : point auquel comparer le point courant
	 * @return : double = distance du point courant au point passé en paramètre
	 * 
	 */
	public double distance(Point pCompare) {
		double dx = this.x - pCompare.x();
		double dy = this.y - pCompare.y();
		double dz = this.z - pCompare.z();
